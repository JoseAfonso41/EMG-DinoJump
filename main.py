...
arquive = open("max_rms.txt", "r")
mvc = arquive.read()


t1 = threading.Thread(target=muscle_detection.contraction_detection, args=[mvc])
t1.start()

t2 = threading.Thread(target=menu(death_count=0), daemon=True)
t2.start()
